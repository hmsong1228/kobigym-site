      ...
      <section className="relative h-screen flex items-center overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-screen-sm sm:max-w-2xl md:max-w-4xl lg:max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="w-full max-w-full md:max-w-3xl flex flex-col items-center md:items-start">
            {/* Main Heading */}
            <h1 className="w-full max-w-[95%] text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black text-beast-red mb-2 md:mb-4 tracking-tight leading-tight text-center md:text-left break-words whitespace-normal animate-fade-in-up">
              KOBY GYM
            </h1>

            {/* Subtitle */}
            <h2 className="w-full max-w-[95%] text-xl sm:text-xl md:text-3xl lg:text-4xl font-bold text-white mb-3 md:mb-7 leading-relaxed text-center md:text-left break-words whitespace-normal animate-fade-in-up animation-delay-100 md:animation-delay-200">
              복싱 · 킥복싱 · 주짓수 · 크로스핏
            </h2>

            {/* Description */}
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl break-words whitespace-normal max-w-[95%] leading-snug px-2 text-center md:leading-relaxed md:text-left md:px-0 md:max-w-2xl text-gray-300 mb-5 md:mb-7 animate-fade-in-up animation-delay-200 md:animation-delay-400">
            ...
            <div className="w-full max-w-[95%] flex flex-col md:flex-row gap-3 md:gap-6 items-center md:items-start animate-fade-in-up animation-delay-300 md:animation-delay-600">
              ...
              <button 
                onClick={openModal}
                className="w-full md:w-56 h-12 md:h-14 bg-white/10 hover:bg-white hover:text-black border-2 border-white text-white font-bold py-3 px-4 md:py-4 md:px-8 rounded-lg text-base md:text-lg transition-all duration-300 backdrop-blur-sm flex items-center justify-center gap-2 whitespace-nowrap"
              >
